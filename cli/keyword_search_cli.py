...
from cli.inverted_index import BM25_B, BM25_K1, InvertedIndex, bm25_idf_command, bm25_tf_command
...
def main() -> None:
    ...
    bm25search_parser.add_argument("--limit", type=int, default=5, help="Maximum number of search results to return")
