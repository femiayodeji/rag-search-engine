from cli.constants import get_citation_summary_prompt, get_question_answering_prompt, get_rag_prompt, get_summary_prompt
...
def get_rag_results_question_answering(query: str, search_result: list[SearchResult]) -> str:
    docs = results_to_formatted_strings(search_result)
    prompt = get_question_answering_prompt(query, docs)
    return get_rag(prompt)